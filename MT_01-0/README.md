...
Привет, студент Школы 21! Сфера IT для тебя новая, и иногда может показаться, что ничего не понятно. Это нормально (и не только для IT-сферы). Справиться с любой сложностью поможет корректно составленный вопрос.
...
Все созданные отчёты и файлы тебе нужно будет загрузить в папку `src/` в корне проекта. Если они уже созданы, то пересоздавать или удалять их не нужно (просто отредактируй этот файл).
...
1. [Chapter I](#chapter-i) \
    1.1. [Тестирование и тестировщики](#тестирование-и-тестировщик) \
    1.2. [QA, QC](#qa-qc) \
    1.3. [Задание №1](#задание-1-виды-тестирования) 
2. [Chapter II](#chapter-ii) \
    2.1. [Уровни тестирования](#уровни-тестирования) \
    2.2. [Стандарты](#стандарты) \
    2.3. [Задание №2](#задание-2-тестирование-в-разработке) 
3. [Chapter III](#chapter-iii) \
    3.1. [Модальные окна](#модальные-окна) \
    3.2. [Чек-боксы](#чек-боксы) \
    3.3. [Задание №3](#задание-3-модальное-окно-авторизации)
...
Создай файл `exercise2.md`. Пользуясь дополнительными материалами, опиши в этом файле: каким образом, на каких стадиях жизненного цикла, кем и в каком составе может проводиться каждый из описанных выше уровней тестирования. Озаглавь свои идеи заголовком `# Уровни тестирования`.
